    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            function geometry(e) {
                ...
                switch (e.type) {
                    ...
                    case "MultiPolygon":
                        for (r = 0; r < e.coordinates.length; r++) t += polygonArea(e.coordinates[r]);
                        return t;
                    case "Point":
                    case "MultiPoint":
                    case "LineString":
                    ...
                    case "GeometryCollection":
                        for (r = 0; r < e.geometries.length; r++) t += geometry(e.geometries[r]);
                        return t
                }
            }
            ...
            function polygonArea(e) {
                ...
                if (e && e.length > 0) {
                    ...
                    for (var t = 1; t < e.length; t++) r -= Math.abs(ringArea(e[t]))
                }
                return r
            }

            function ringArea(e) {
                var r, t, n, o, a, i, g, s = 0,
                    l = e.length;
                if (l > 2) {
                    for (g = 0; g < l; g++) g === l - 2 ? (o = l - 2, a = l - 1, i = 0) : g === l - 1 ? (o = l - 1, a = 0, i = 1) : (o = g, a = g + 1, i = g + 2), r = e[o], t = e[a], n = e[i], s += (rad(n[0]) - rad(r[0])) * Math.sin(rad(t[1]));
        ...
        2: [function(require, module, exports) {
            var area = require("@mapbox/geojson-area").geometry,
                geomReduce = require("@turf/meta").geomReduce;
            module.exports = function(e) {
                return geomReduce(e, function(e, r) {
                    return e + area(r)
                }, 0)
            };
        }, {
        ...
        3: [function(require, module, exports) {
            function removeEmptyPolygon(e) {
                switch (e.type) {
                    case "Polygon":
                        return area(e) > 1 ? e : null;
                    case "MultiPolygon":
                        var r = [];
                        if (flattenEach(e, function(e) {
                                area(e) > 1 && r.push(e.geometry.coordinates)
                            }), r.length) return {
                            type: "MultiPolygon",
                            coordinates: r
                        }
            ...
            var jsts = require("jsts"),
                ...
                getGeom = require("@turf/invariant").getGeom,
                flattenEach = require("@turf/meta").flattenEach;
            module.exports = function(e, r) {
                var t = getGeom(e),
                    o = getGeom(r),
                    a = e.properties || {};
                if (t = removeEmptyPolygon(t), o = removeEmptyPolygon(o), !t) return null;
                if (!o) return feature(t, a);
                var n = new jsts.io.GeoJSONReader,
                    u = n.read(t),
                    i = n.read(o),
                    f = u.difference(i);
                if (f.isEmpty()) return null;
                var l = new jsts.io.GeoJSONWriter,
                    s = l.write(f);
                return feature(s, a)
            };
        }, {
        ...
        4: [function(require, module, exports) {
            function feature(r, e, t, o) {
                ...
                if (o && -1 === ["string", "number"].indexOf(typeof o)) throw new Error("id must be a number or a string");
                var n = {
                    type: "Feature"
                };
                return o && (n.id = o), t && (n.bbox = t), n.properties = e || {}, n.geometry = r, n
            }

            function geometry(r, e, t) {
                ...
                switch (r) {
                    case "Point":
                        ...
                        break;
                    case "LineString":
                        o = lineString(e).geometry;
                        break;
                    case "Polygon":
                        o = polygon(e).geometry;
                        break;
                    case "MultiPoint":
                        o = multiPoint(e).geometry;
                        break;
                    case "MultiLineString":
                        o = multiLineString(e).geometry;
                        break;
                    case "MultiPolygon":
                        o = multiPolygon(e).geometry;
                        break;
                    default:
            ...
            function point(r, e, t, o) {
                if (!r) throw new Error("No coordinates passed");
                if (void 0 === r.length) throw new Error("Coordinates must be an array");
                if (r.length < 2) throw new Error("Coordinates must be at least 2 numbers long");
                if (!isNumber(r[0]) || !isNumber(r[1])) throw new Error("Coordinates must contain numbers");
                return feature({
                    type: "Point",
                    coordinates: r
                }, e, t, o)
            ...
            function polygon(r, e, t, o) {
                ...
                for (var n = 0; n < r.length; n++) {
                    ...
                    for (var a = 0; a < i[i.length - 1].length; a++) {
                        if (0 === n && 0 === a && !isNumber(i[0][0]) || !isNumber(i[0][1])) throw new Error("Coordinates must contain numbers");
                        if (i[i.length - 1][a] !== i[0][a]) throw new Error("First and last Position are not equivalent.")
                    }
                }
                return feature({
                    type: "Polygon",
            ...
            function lineString(r, e, t, o) {
                if (!r) throw new Error("No coordinates passed");
                if (r.length < 2) throw new Error("Coordinates must be an array of two or more positions");
                if (!isNumber(r[0][1]) || !isNumber(r[0][1])) throw new Error("Coordinates must contain numbers");
                return feature({
                    type: "LineString",
                    coordinates: r
                }, e, t, o)
            ...
            function featureCollection(r, e, t) {
                ...
                if (t && -1 === ["string", "number"].indexOf(typeof t)) throw new Error("id must be a number or a string");
                var o = {
                    type: "FeatureCollection"
                };
                return t && (o.id = t), e && (o.bbox = e), o.features = r, o
            }

            function multiLineString(r, e, t, o) {
                if (!r) throw new Error("No coordinates passed");
                return feature({
            ...
            function geometryCollection(r, e, t, o) {
            ...
            function round(r, e) {
                if (void 0 === r || null === r || isNaN(r)) throw new Error("num is required");
                if (e && !(e >= 0)) throw new Error("precision must be a positive number");
                var t = Math.pow(10, e || 0);
                return Math.round(r * t) / t
            }

            function radiansToDistance(r, e) {
                if (void 0 === r || null === r) throw new Error("radians is required");
                var t = factors[e || "kilometers"];
                if (!t) throw new Error("units is invalid");
                return r * t
            }

            function distanceToRadians(r, e) {
                if (void 0 === r || null === r) throw new Error("distance is required");
                var t = factors[e || "kilometers"];
                if (!t) throw new Error("units is invalid");
                return r / t
            }

            function distanceToDegrees(r, e) {
                return radians2degrees(distanceToRadians(r, e))
            }

            function bearingToAngle(r) {
                if (null === r || void 0 === r) throw new Error("bearing is required");
                var e = r % 360;
                return e < 0 && (e += 360), e
            }

            function radians2degrees(r) {
                if (null === r || void 0 === r) throw new Error("radians is required");
                return r % (2 * Math.PI) * 180 / Math.PI
            }

            function degrees2radians(r) {
                if (null === r || void 0 === r) throw new Error("degrees is required");
                return r % 360 * Math.PI / 180
            }

            function convertDistance(r, e, t) {
                if (null === r || void 0 === r) throw new Error("distance is required");
                if (!(r >= 0)) throw new Error("distance must be a positive number");
                return radiansToDistance(distanceToRadians(r, e), t || "kilometers")
            }

            function convertArea(r, e, t) {
                if (null === r || void 0 === r) throw new Error("area is required");
                if (!(r >= 0)) throw new Error("area must be a positive number");
                var o = areaFactors[e || "meters"];
                if (!o) throw new Error("invalid original units");
                var n = areaFactors[t || "kilometers"];
        ...
        5: [function(require, module, exports) {
            function getCoord(e) {
                ...
                var r = getCoords(e);
                if (r.length > 1 && "number" == typeof r[0] && "number" == typeof r[1]) return r;
            ...
            function getCoords(e) {
                if (!e) throw new Error("obj is required");
                var r;
                if (e.length ? r = e : e.coordinates ? r = e.coordinates : e.geometry && e.geometry.coordinates && (r = e.geometry.coordinates), r) return containsNumber(r), r;
                throw new Error("No valid coordinates")
            }

            function containsNumber(e) {
                if (e.length > 1 && "number" == typeof e[0] && "number" == typeof e[1]) return !0;
                if (Array.isArray(e[0]) && e[0].length) return containsNumber(e[0]);
                throw new Error("coordinates must only contain numbers")
            }

            function geojsonType(e, r, o) {
                if (!r || !o) throw new Error("type and name required");
                if (!e || e.type !== r) throw new Error("Invalid input to " + o + ": must be a " + r + ", given " + e.type)
            }

            function featureOf(e, r, o) {
                if (!e) throw new Error("No feature passed");
                if (!o) throw new Error(".featureOf() requires a name");
                if (!e || "Feature" !== e.type || !e.geometry) throw new Error("Invalid input to " + o + ", Feature with geometry required");
                if (!e.geometry || e.geometry.type !== r) throw new Error("Invalid input to " + o + ": must be a " + r + ", given " + e.geometry.type)
            }

            function collectionOf(e, r, o) {
                if (!e) throw new Error("No featureCollection passed");
                if (!o) throw new Error(".collectionOf() requires a name");
                if (!e || "FeatureCollection" !== e.type) throw new Error("Invalid input to " + o + ", FeatureCollection required");
                for (var t = 0; t < e.features.length; t++) {
                    var n = e.features[t];
                    if (!n || "Feature" !== n.type || !n.geometry) throw new Error("Invalid input to " + o + ", Feature with geometry required");
                    if (!n.geometry || n.geometry.type !== r) throw new Error("Invalid input to " + o + ": must be a " + r + ", given " + n.geometry.type)
                }
            }
        ...
        6: [function(require, module, exports) {
            ...
            function coordEach(e, t, r) {
                if (null !== e) {
                    var o, n, i, a, c, u, l, s, f, g, p = 0,
                        h = 0,
                        d = e.type,
                        y = "FeatureCollection" === d,
                        m = "Feature" === d,
                        E = y ? e.features.length : 1;
                    for (o = 0; o < E; o++)
                        for (f = y ? e.features[o].geometry : m ? e.geometry : e, g = !!f && "GeometryCollection" === f.type, l = g ? f.geometries.length : 1, n = 0; n < l; n++) {
                            var v = 0;
                            if (null !== (u = g ? f.geometries[n] : f)) {
                                s = u.coordinates;
                                var w = u.type;
                                switch (p = !r || "Polygon" !== w && "MultiPolygon" !== w ? 0 : 1, w) {
                                    ...
                                    case "LineString":
                                    case "MultiPoint":
                                        for (i = 0; i < s.length; i++) t(s[i], h, o, v), h++, "MultiPoint" === w && v++;
                                        "LineString" === w && v++;
                                        break;
                                    case "Polygon":
                                    case "MultiLineString":
                                        for (i = 0; i < s.length; i++) {
                                            for (a = 0; a < s[i].length - p; a++) t(s[i][a], h, o, v), h++;
                                            "MultiLineString" === w && v++
                                        }
                                        "Polygon" === w && v++;
                                        break;
                                    case "MultiPolygon":
                                        for (i = 0; i < s.length; i++) {
                                            for (a = 0; a < s[i].length; a++)
                                                for (c = 0; c < s[i][a].length - p; c++) t(s[i][a][c], h, o, v), h++;
                                            v++
                                        }
                                        break;
                                    case "GeometryCollection":
                                        for (i = 0; i < u.geometries.length; i++) coordEach(u.geometries[i], t, r);
                                        break;
                                    default:
            ...
            function coordReduce(e, t, r, o) {
                var n = r;
                return coordEach(e, function(e, o, i, a) {
                    n = 0 === o && void 0 === r ? e : t(n, e, o, i, a)
                }, o), n
            }

            function propEach(e, t) {
                var r;
                switch (e.type) {
                    case "FeatureCollection":
                        for (r = 0; r < e.features.length; r++) t(e.features[r].properties, r);
                        break;
                    case "Feature":
                        t(e.properties, 0)
                }
            ...
            function propReduce(e, t, r) {
                var o = r;
                return propEach(e, function(e, n) {
                    o = 0 === n && void 0 === r ? e : t(o, e, n)
                }), o
            }

            function featureEach(e, t) {
                if ("Feature" === e.type) t(e, 0);
                else if ("FeatureCollection" === e.type)
                    for (var r = 0; r < e.features.length; r++) t(e.features[r], r)
            }

            function featureReduce(e, t, r) {
                var o = r;
                return featureEach(e, function(e, n) {
                    o = 0 === n && void 0 === r ? e : t(o, e, n)
                }), o
            }
            ...
            function geomEach(e, t) {
                var r, o, n, i, a, c, u, l, s = 0,
                    f = "FeatureCollection" === e.type,
                    g = "Feature" === e.type,
                    p = f ? e.features.length : 1;
                for (r = 0; r < p; r++) {
                    for (c = f ? e.features[r].geometry : g ? e.geometry : e, l = f ? e.features[r].properties : g ? e.properties : {}, u = !!c && "GeometryCollection" === c.type, a = u ? c.geometries.length : 1, n = 0; n < a; n++)
                        if (null !== (i = u ? c.geometries[n] : c)) switch (i.type) {
                            case "Point":
                            case "LineString":
                            case "MultiPoint":
                            case "Polygon":
                            ...
                            case "MultiPolygon":
                                ...
                                break;
                            case "GeometryCollection":
                                for (o = 0; o < i.geometries.length; o++) t(i.geometries[o], s, l);
                                break;
                            default:
                                throw new Error("Unknown Geometry Type")
                        } else t(null, s, l);
            ...
            function geomReduce(e, t, r) {
                var o = r;
                return geomEach(e, function(e, n, i) {
                    o = 0 === n && void 0 === r ? e : t(o, e, n, i)
                }), o
            }

            function flattenEach(e, t) {
                geomEach(e, function(e, r, o) {
                    var n = null === e ? null : e.type;
                    switch (n) {
                        case null:
                        case "Point":
                        case "LineString":
                        case "Polygon":
                            return void t(feature(e, o), r, 0)
                    }
                    var i;
                    switch (n) {
                        case "MultiPoint":
                    ...
                    e.coordinates.forEach(function(e, n) {
                        t(feature({
                            type: i,
                            coordinates: e
                        }, o), r, n)
            ...
            function flattenReduce(e, t, r) {
                var o = r;
                return flattenEach(e, function(e, n, i) {
                    o = 0 === n && 0 === i && void 0 === r ? e : t(o, e, n, i)
                }), o
            }

            function segmentEach(e, t) {
                flattenEach(e, function(e, r, o) {
                    var n = 0;
                    if (e.geometry) {
                        var i = e.geometry.type;
                        "Point" !== i && "MultiPoint" !== i && coordReduce(e, function(i, a) {
                            var c = lineString([i, a], e.properties);
                            return t(c, r, o, n), n++, a
                        })
                    }
                })
            }

            function segmentReduce(e, t, r) {
                var o = r,
                    n = !1;
                return segmentEach(e, function(e, i, a, c) {
                    o = !1 === n && void 0 === r ? e : t(o, e, i, a, c), n = !0
                }), o
            }
            ...
            function lineEach(e, t) {
                if (!e) throw new Error("geojson is required");
                var r = e.geometry ? e.geometry.type : e.type;
                if (!r) throw new Error("invalid geojson");
                if ("FeatureCollection" === r) throw new Error("FeatureCollection is not supported");
                if ("GeometryCollection" === r) throw new Error("GeometryCollection is not supported");
                var o = e.geometry ? e.geometry.coordinates : e.coordinates;
                if (!o) throw new Error("geojson must contain coordinates");
                switch (r) {
                    case "LineString":
                        return void t(o, 0, 0);
                    case "Polygon":
                    case "MultiLineString":
                        for (var n = 0, i = 0; i < o.length; i++) "MultiLineString" === r && (n = i), t(o[i], i, n);
                        return;
                    case "MultiPolygon":
                        for (var a = 0; a < o.length; a++)
                            for (var c = 0; c < o[a].length; c++) t(o[a][c], c, a);
                        return;
                    default:
        ...
        7: [function(require, module, exports) {
            ! function(t, e) {
                ...
                function bt() {
                    ...
                    } else if (R(arguments[0], D) && arguments[1] instanceof ne) {
                        var n = arguments[0],
                            i = arguments[1];
                ...
                function Wt() {
                    return Zt(this._itp, this._keys)
                }

                function jt() {
                    return Zt(this._itp, this._values)
                }

                function Kt() {
                    return Zt(this._itp, this._keys, this._values)
                }
                ...
                function xe() {
                    if (this.snapTolerance = 0, this.srcPts = null, this.seg = new he, this.allowSnappingToSourceVertices = !1, this._isClosed = !1, arguments[0] instanceof St && "number" == typeof arguments[1]) {
                        var t = arguments[0],
                            e = arguments[1];
                        xe.call(this, t.getCoordinates(), e)
                    } else if (arguments[0] instanceof Array && "number" == typeof arguments[1]) {
                        var n = arguments[0],
                            i = arguments[1];
                        this.srcPts = n, this._isClosed = xe.isClosed(n), this.snapTolerance = i
                    }
                }
                ...
                function qe() {
                    if (this.root = null, this.built = !1, this.itemBoundables = new I, this.nodeCapacity = null, 0 === arguments.length) qe.call(this, qe.DEFAULT_NODE_CAPACITY);
                    else if (1 === arguments.length) {
                        var t = arguments[0];
                ...
                function Ve() {
                    if (0 === arguments.length) Ve.call(this, Ve.DEFAULT_NODE_CAPACITY);
                    else if (1 === arguments.length) {
                        var t = arguments[0];
                        qe.call(this, t)
                    }
                ...
                function en() {
                    if (this.monoChains = new I, this.index = new Ve, this.idCounter = 0, this.nodedSegStrings = null, this.nOverlaps = 0, 0 === arguments.length);
                    else if (1 === arguments.length) {
                        var t = arguments[0];
                        tn.call(this, t)
                    }
                ...
                function fn() {
                    if (this.elt = new Array(2).fill(null), 1 === arguments.length) {
                        ...
                        var n = arguments[0],
                            i = arguments[1];
                        this.elt[0] = new cn(L.NONE), this.elt[1] = new cn(L.NONE), this.elt[n].setLocation(i)
                    } else if (3 === arguments.length) {
                        var r = arguments[0],
                            s = arguments[1],
                            o = arguments[2];
                        ...
                        var a = arguments[0],
                            ...
                            l = arguments[2],
                            h = arguments[3];
                        this.elt[0] = new cn(L.NONE, L.NONE, L.NONE), this.elt[1] = new cn(L.NONE, L.NONE, L.NONE), this.elt[a].setLocations(u, l, h)
                    }
                }
                ...
                function xn() {
                    if (this.edge = null, this.label = null, this.node = null, this.p0 = null, this.p1 = null, this.dx = null, this.dy = null, this.quadrant = null, 1 === arguments.length) {
                        ...
                        var e = arguments[0],
                            n = arguments[1],
                            i = arguments[2];
                        xn.call(this, e, n, i, null)
                    } else if (4 === arguments.length) {
                        var r = arguments[0],
                            s = arguments[1],
                            o = arguments[2],
                            a = arguments[3];
                        xn.call(this, r), this.init(s, o), this.label = a
                    }
                }
                ...
                function An() {
                    Mn.apply(this), this.events = new I, this.nOverlaps = null
                }
                ...
                function Zn() {
                    ...
                    for (var t = 0; t < 2; t++)
                        for (var e = 0; e < 3; e++) this.depth[t][e] = Zn.NULL_VALUE
                }

                function Qn() {
                    if (mn.apply(this), this.pts = null, this.env = null, this.eiList = new Wn(this), this.name = null, this.mce = null, this._isIsolated = !0, this.depth = new Zn, this.depthDelta = 0, 1 === arguments.length) {
                        var t = arguments[0];
                        Qn.call(this, t, null)
                    } else if (2 === arguments.length) {
                        var e = arguments[0],
                ...
                function Jn() {
                    if (Nn.apply(this), this.parentGeom = null, this.lineEdgeMap = new $t, this.boundaryNodeRule = null, this.useBoundaryDeterminationRule = !0, this.argIndex = null, this.boundaryNodes = null, this._hasTooFewPoints = !1, this.invalidPoint = null, this.areaPtLocator = null, this.ptLocator = new Re, 2 === arguments.length) {
                        var t = arguments[0],
                            e = arguments[1];
                        Jn.call(this, t, e, V.OGC_SFS_BOUNDARY_RULE)
                    } else if (3 === arguments.length) {
                        var n = arguments[0],
                            i = arguments[1],
                            r = arguments[2];
                ...
                function $n() {
                    if (this.li = new oe, this.resultPrecisionModel = null, this.arg = null, 1 === arguments.length) {
                        var t = arguments[0];
                        this.setComputationPrecision(t.getPrecisionModel()), this.arg = new Array(1).fill(null), this.arg[0] = new Jn(0, t)
                    } else if (2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1];
                        $n.call(this, e, n, V.OGC_SFS_BOUNDARY_RULE)
                    } else if (3 === arguments.length) {
                        var i = arguments[0],
                            r = arguments[1],
                            s = arguments[2];
                        i.getPrecisionModel().compareTo(r.getPrecisionModel()) >= 0 ? this.setComputationPrecision(i.getPrecisionModel()) : this.setComputationPrecision(r.getPrecisionModel()), this.arg = new Array(2).fill(null), this.arg[0] = new Jn(0, i, s), this.arg[1] = new Jn(1, r, s)
                    }
                }
                ...
                function ni() {
                    this.ptLocator = new Re, this.geomFact = null, this.resultGeom = null, this.graph = null, this.edgeList = new ei, this.resultPolyList = new I, this.resultLineList = new I, this.resultPointList = new I;
                    var t = arguments[0],
                        e = arguments[1];
                    $n.call(this, t, e), this.graph = new Nn(new bn), this.geomFact = t.getFactory()
                }
                ...
                function Mi() {
                    this.result = null, this.factory = null, this.graph = null, this.lines = new I, this.nodeEdgeStack = new de, this.ringStartEdge = null, this.graph = new _i
                }
                ...
                function qi() {
                    this.root = null, this.minExtent = 1, this.root = new Gi
                }
                ...
                function ji() {
                    if (this.quadrantSegments = ji.DEFAULT_QUADRANT_SEGMENTS, this.endCapStyle = ji.CAP_ROUND, this.joinStyle = ji.JOIN_ROUND, this.mitreLimit = ji.DEFAULT_MITRE_LIMIT, this._isSingleSided = !1, this.simplifyFactor = ji.DEFAULT_SIMPLIFY_FACTOR, 0 === arguments.length);
                    else if (1 === arguments.length) {
                        var t = arguments[0];
                ...
                function tr() {
                    ...
                    var t = arguments[0],
                        e = arguments[1],
                        n = arguments[2];
                    this.precisionModel = t, this.bufParams = e, this.li = new oe, this.filletAngleQuantum = Math.PI / 2 / e.getQuadrantSegments(), e.getQuadrantSegments() >= 8 && e.getJoinStyle() === ji.JOIN_ROUND && (this.closingSegLengthFactor = tr.MAX_CLOSING_SEG_LEN_FACTOR), this.init(n)
                }
                ...
                function gr() {
                    if (this.argGeom = null, this.distance = null, this.bufParams = new ji, this.resultGeometry = null, this.saveException = null, 1 === arguments.length) {
                        var t = arguments[0];
                        this.argGeom = t
                    } else if (2 === arguments.length) {
                        var e = arguments[0],
                ...
                function yr() {
                    if (this.geom = null, this.terminateDistance = 0, this.ptLocator = new Re, this.minDistanceLocation = null, this.minDistance = r.MAX_VALUE, 2 === arguments.length) {
                        var t = arguments[0],
                            e = arguments[1];
                        yr.call(this, t, e, 0)
                    } else if (3 === arguments.length) {
                ...
                function Ir() {
                    Er.apply(this), this.parentEdge = null, this.from = null, this.to = null, this.p0 = null, this.p1 = null, this.sym = null, this.edgeDirection = null, this.quadrant = null, this.angle = null;
                    var t = arguments[0],
                        e = arguments[1],
                        n = arguments[2],
                        i = arguments[3];
                ...
                function Cr() {
                    if (Er.apply(this), this.dirEdge = null, 0 === arguments.length);
                    else if (2 === arguments.length) {
                        var t = arguments[0],
                            e = arguments[1];
                ...
                function wr() {
                    if (Er.apply(this), this.pt = null, this.deStar = null, 1 === arguments.length) {
                        var t = arguments[0];
                        wr.call(this, t, new Sr)
                    } else if (2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1];
                ...
                function Tr() {
                    this.edges = new J, this.dirEdges = new J, this.nodeMap = new Rr
                }
                ...
                function br() {
                    this.graph = new Pr, this.mergedLineStrings = null, this.factory = null, this.edgeStrings = null
                }
                ...
                function Ar() {
                    if (this.edgeEnds = new I, 1 === arguments.length) {
                        ...
                        xn.call(this, e.getEdge(), e.getCoordinate(), e.getDirectedCoordinate(), new fn(e.getLabel())), this.insert(e)
                    }
                }
                ...
                function Hr() {
                    Tr.apply(this), this.factory = null;
                    var t = arguments[0];
                    this.factory = t
                }

                function Wr() {
                    if (this.lineStringAdder = new jr(this), this.graph = null, this.dangles = new I, this.cutEdges = new I, this.invalidRingLines = new I, this.holeList = null, this.shellList = null, this.polyList = null, this.isCheckingRingsValid = !0, this.extractOnlyPolygonal = null, this.geomFactory = null, 0 === arguments.length) Wr.call(this, !1);
                    else if (1 === arguments.length) {
                        var t = arguments[0];
                ...
                function Kr() {
                    this.li = new oe, this.ptLocator = new Re, this.arg = null, this.nodes = new yn(new qr), this.im = null, this.isolatedEdges = new I, this.invalidPoint = null;
                    var t = arguments[0];
                    this.arg = t
                }
                ...
                function ts() {
                    Jr.apply(this), this.rectEnv = null, this._intersects = !1;
                    var t = arguments[0];
                    this.rectEnv = t
                }

                function es() {
                    Jr.apply(this), this.rectSeq = null, this.rectEnv = null, this._containsPoint = !1;
                    var t = arguments[0];
                    this.rectSeq = t.getExteriorRing().getCoordinateSequence(), this.rectEnv = t.getEnvelopeInternal()
                }

                function ns() {
                    Jr.apply(this), this.rectEnv = null, this.rectIntersector = null, this.hasIntersection = !1, this.p0 = new g, this.p1 = new g;
                    var t = arguments[0];
                    this.rectEnv = t.getEnvelopeInternal(), this.rectIntersector = new Qr(this.rectEnv)
                }
                ...
                function Es() {
                    this.inputGeom = null, this.lineSimplifier = new xs, this.linestringMap = null;
                    var t = arguments[0];
                    this.inputGeom = t
                }
                ...
                function Ms() {
                    if (this.seg = null, 1 === arguments.length) {
                        ...
                        var n = arguments[0],
                            i = arguments[1];
                        l.call(this, Ms.msgWithSpatial(n, i)), this.seg = new he(i)
                    }
                }
                ...
                function As() {
                    ...
                    var t = arguments[0],
                        e = arguments[1];
                    this.tolerance = e, this.edgeCoincidenceTolerance = e / As.EDGE_COINCIDENCE_TOL_FACTOR, this.createFrame(t), this.startingEdge = this.initSubdiv(), this.locator = new _s(this)
                }
                ...
                function zs() {
                    if (this.ls = null, this.data = null, 2 === arguments.length) {
                        ...
                        var s = arguments[0],
                            ...
                            l = arguments[4],
                            h = arguments[5];
                        zs.call(this, new g(s, o, a), new g(u, l, h))
                        ...
                        var c = arguments[0],
                            ...
                            v = arguments[5],
                            y = arguments[6];
                        zs.call(this, new g(c, f, d), new g(p, m, v), y)
                    }
                }
                ...
                function Xs() {
                    this.initialVertices = null, this.segVertices = null, this.segments = new I, this.subdiv = null, this.incDel = null, this.convexHull = null, this.splitFinder = new ws, this.kdt = null, this.vertexFactory = null, this.computeAreaEnv = null, this.splitPt = null, this.tolerance = null;
                    var t = arguments[0],
                        e = arguments[1];
                ...
                Zs.prototype.next = function() {
                    ...
                    divide: function() {
                        ...
                        if ("number" == typeof arguments[0]) {
                            var h = arguments[0];
                            return r.isNaN(h) ? _.createNaN() : _.copy(this).selfDivide(h, 0)
                        }
                    },
                    ge: function(t) {
                        return this.hi > t.hi || this.hi === t.hi && this.lo >= t.lo
                    ...
                    for (var s = new _, o = 0, a = 0, u = 0; !(e >= n);) {
                        var l = t.charAt(e);
                        if (e++, O.isDigit(l)) {
                            var h = l - "0";
                    ...
                    return new g(c, _.valueOf(n.y).selfAdd(_.valueOf(i.y).selfSubtract(n.y).selfMultiply(m)).doubleValue())
                    ...
                    var s = t.y - e.y,
                        ...
                        p = c / d,
                        m = f / d;
                    if (r.isNaN(p) || r.isInfinite(p) || r.isNaN(m) || r.isInfinite(m)) throw new w;
                    return new g(p, m)
                }, e(G.prototype, {
                    create: function() {
                        1 === arguments.length ? arguments[0] instanceof Array ? arguments[0] : R(arguments[0], D) && arguments[0] : 2 === arguments.length && (arguments[0], arguments[1])
                    },
                    interfaces_: function() {
                        return []
                    },
                ...
                rt.prototype = new Z, rt.prototype.get = function(t) {
                    ...
                    for (t.color = 1; null != t && t != this.root_ && 1 == t.parent.color;)
                        if (tt(t) == nt(tt(tt(t)))) {
                            var e = it(tt(tt(t)));
                            1 == $(e) ? (et(tt(t), Js), et(e, Js), et(tt(tt(t)), 1), t = tt(tt(t))) : (t == it(tt(t)) && (t = tt(t), this.rotateLeft(t)), et(tt(t), Js), et(tt(tt(t)), 1), this.rotateRight(tt(tt(t))))
                        } else {
                            var e = nt(tt(tt(t)));
                            1 == $(e) ? (et(tt(t), Js), et(e, Js), et(tt(tt(t)), 1), t = tt(tt(t))) : (t == nt(tt(t)) && (t = tt(t), this.rotateRight(t)), et(tt(t), Js), et(tt(tt(t)), 1), this.rotateLeft(tt(tt(t))))
                        }
                    this.root_.color = Js
                ...
                $s.prototype.next = function() {
                    ...
                    create: function() {
                        if (1 === arguments.length) {
                            ...
                            var t = arguments[0],
                                e = arguments[1];
                            return e > 3 && (e = 3), e < 2 ? new Gt(t) : new Gt(t, e)
                        }
                    },
                    interfaces_: function() {
                        return [G, u]
                ...
                $t.prototype = new K, $t.prototype.get = function(t) {
                    ...
                    buildGeometry: function(t) {
                        ...
                        if (t.size() > 1) {
                            if (a instanceof Tt) return this.createMultiPolygon(ne.toPolygonArray(t));
                            if (a instanceof St) return this.createMultiLineString(ne.toLineStringArray(t));
                            if (a instanceof Lt) return this.createMultiPoint(ne.toPointArray(t));
                    ...
                    createLinearRing: function() {
                        ...
                        if (1 === arguments.length) {
                            ...
                            if (R(arguments[0], D)) {
                                return new bt(arguments[0], this)
                            }
                        }
                    },
                    ...
                    createMultiPoint: function() {
                        ...
                        if (1 === arguments.length) {
                            if (arguments[0] instanceof Array) {
                                return new Pt(arguments[0], this)
                            }
                            if (arguments[0] instanceof Array) {
                                var t = arguments[0];
                                return this.createMultiPoint(null !== t ? this.getCoordinateSequenceFactory().create(t) : null)
                ...
                e(re.prototype, {
                    ...
                    return r ? T.min(le.distancePointLine(t, n, i), le.distancePointLine(e, n, i), le.distancePointLine(n, t, e), le.distancePointLine(i, t, e)) : 0
                }, le.isPointInRing = function(t, e) {
                    return le.locatePointInRing(t, e) !== L.EXTERIOR
                    ...
                    isCovers: function() {
                        return (ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) || ce.isTrue(this.matrix[L.INTERIOR][L.BOUNDARY]) || ce.isTrue(this.matrix[L.BOUNDARY][L.INTERIOR]) || ce.isTrue(this.matrix[L.BOUNDARY][L.BOUNDARY])) && this.matrix[L.EXTERIOR][L.INTERIOR] === lt.FALSE && this.matrix[L.EXTERIOR][L.BOUNDARY] === lt.FALSE
                    },
                    isCoveredBy: function() {
                        return (ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) || ce.isTrue(this.matrix[L.INTERIOR][L.BOUNDARY]) || ce.isTrue(this.matrix[L.BOUNDARY][L.INTERIOR]) || ce.isTrue(this.matrix[L.BOUNDARY][L.BOUNDARY])) && this.matrix[L.INTERIOR][L.EXTERIOR] === lt.FALSE && this.matrix[L.BOUNDARY][L.EXTERIOR] === lt.FALSE
                    },
                    set: function() {
                        if (1 === arguments.length)
                    ...
                    isContains: function() {
                        return ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && this.matrix[L.EXTERIOR][L.INTERIOR] === lt.FALSE && this.matrix[L.EXTERIOR][L.BOUNDARY] === lt.FALSE
                    },
                    setAtLeast: function() {
                        if (1 === arguments.length)
                            for (var t = arguments[0], e = 0; e < t.length; e++) {
                    ...
                    isWithin: function() {
                        return ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && this.matrix[L.INTERIOR][L.EXTERIOR] === lt.FALSE && this.matrix[L.BOUNDARY][L.EXTERIOR] === lt.FALSE
                    },
                    isTouches: function(t, e) {
                        return t > e ? this.isTouches(e, t) : (t === lt.A && e === lt.A || t === lt.L && e === lt.L || t === lt.L && e === lt.A || t === lt.P && e === lt.A || t === lt.P && e === lt.L) && this.matrix[L.INTERIOR][L.INTERIOR] === lt.FALSE && (ce.isTrue(this.matrix[L.INTERIOR][L.BOUNDARY]) || ce.isTrue(this.matrix[L.BOUNDARY][L.INTERIOR]) || ce.isTrue(this.matrix[L.BOUNDARY][L.BOUNDARY]))
                    },
                    isOverlaps: function(t, e) {
                        return t === lt.P && e === lt.P || t === lt.A && e === lt.A ? ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && ce.isTrue(this.matrix[L.INTERIOR][L.EXTERIOR]) && ce.isTrue(this.matrix[L.EXTERIOR][L.INTERIOR]) : t === lt.L && e === lt.L && 1 === this.matrix[L.INTERIOR][L.INTERIOR] && ce.isTrue(this.matrix[L.INTERIOR][L.EXTERIOR]) && ce.isTrue(this.matrix[L.EXTERIOR][L.INTERIOR])
                    },
                    isEquals: function(t, e) {
                        return t === e && ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && this.matrix[L.INTERIOR][L.EXTERIOR] === lt.FALSE && this.matrix[L.BOUNDARY][L.EXTERIOR] === lt.FALSE && this.matrix[L.EXTERIOR][L.INTERIOR] === lt.FALSE && this.matrix[L.EXTERIOR][L.BOUNDARY] === lt.FALSE
                    },
                    toString: function() {
                    ...
                    isCrosses: function(t, e) {
                        return t === lt.P && e === lt.L || t === lt.P && e === lt.A || t === lt.L && e === lt.A ? ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && ce.isTrue(this.matrix[L.INTERIOR][L.EXTERIOR]) : t === lt.L && e === lt.P || t === lt.A && e === lt.P || t === lt.A && e === lt.L ? ce.isTrue(this.matrix[L.INTERIOR][L.INTERIOR]) && ce.isTrue(this.matrix[L.EXTERIOR][L.INTERIOR]) : t === lt.L && e === lt.L && 0 === this.matrix[L.INTERIOR][L.INTERIOR]
                    },
                    interfaces_: function() {
                        return [o]
                    },
                ...
                e(fe.prototype, {
                ...
                }), Ee.snap = function(t, e, n) {
                    var i = new Array(2).fill(null),
                        r = new Ee(t);
                    i[0] = r.snapTo(e, n);
                    var s = new Ee(e);
                    return i[1] = s.snapTo(i[0], n), i
                }, Ee.computeOverlaySnapTolerance = function() {
                    if (1 === arguments.length) {
                        var t = arguments[0],
                            e = Ee.computeSizeBasedSnapTolerance(t),
                    ...
                    if (2 === arguments.length) {
                        var r = arguments[0],
                            s = arguments[1];
                        return Math.min(Ee.computeOverlaySnapTolerance(r), Ee.computeOverlaySnapTolerance(s))
                    }
                }, Ee.computeSizeBasedSnapTolerance = function(t) {
                    var e = t.getEnvelopeInternal();
                    return Math.min(e.getHeight(), e.getWidth()) * Ee.SNAP_PRECISION_FACTOR
                }, Ee.snapToSelf = function(t, e, n) {
                    return new Ee(t).snapToSelf(e, n)
                }, Ee.SNAP_PRECISION_FACTOR = 1e-9, h(Ie, ye), e(Ie.prototype, {
                    snapLine: function(t, e) {
                        var n = new xe(t, this.snapTolerance);
                ...
                }), Ce.CommonCoordinateFilter = Se, Ce.Translater = we, e(Le.prototype, {
                    next: function() {
                        if (this.atStart) return this.atStart = !1, Le.isAtomic(this.parent) && this.index++, this.parent;
                        ...
                        return t instanceof ft ? (this.subcollectionIterator = new Le(t), this.subcollectionIterator.next()) : t
                    },
                    remove: function() {
                    ...
                    locateInternal: function() {
                        ...
                        if (arguments[0] instanceof g && arguments[1] instanceof St) {
                            ...
                            return u.isClosed() || !a.equals(l[0]) && !a.equals(l[l.length - 1]) ? le.isOnLine(a, l) ? L.INTERIOR : L.EXTERIOR : L.BOUNDARY
                        }
                    ...
                    locateInPolygonRing: function(t, e) {
                        return e.getEnvelopeInternal().intersects(t) ? le.locatePointInRing(t, e.getCoordinates()) : L.EXTERIOR
                    },
                ...
                e(Ge.prototype, {
                    expandToQueue: function(t, e) {
                        ...
                        if (n && r) return Ge.area(this.boundable1) > Ge.area(this.boundable2) ? (this.expand(this.boundable1, this.boundable2, t, e), null) : (this.expand(this.boundable2, this.boundable1, t, e), null);
                    ...
                    expand: function(t, e, n, i) {
                        for (var r = t.getChildBoundables(), s = r.iterator(); s.hasNext();) {
                            var o = s.next(),
                                a = new Ge(o, e, this.itemDistance);
                    ...
                    size: function() {
                        ...
                        if (1 === arguments.length) {
                            for (var t = arguments[0], e = 0, n = t.getChildBoundables().iterator(); n.hasNext();) {
                                var i = n.next();
                                i instanceof Fe ? e += this.size(i) : i instanceof _e && (e += 1)
                            }
                            return e
                        }
                    },
                    ...
                    insert: function(t, e) {
                        f.isTrue(!this.built, "Cannot insert items into an STR packed R-tree after it has been built."), this.itemBoundables.add(new _e(t, e))
                    },
                    boundablesAtLevel: function() {
                        ...
                        if (3 === arguments.length) {
                            ...
                            for (var s = i.getChildBoundables().iterator(); s.hasNext();) {
                                var o = s.next();
                                o instanceof Fe ? this.boundablesAtLevel(n, o, r) : (f.isTrue(o instanceof _e), -1 === n && r.add(o))
                            }
                            return null
                        }
                    },
                    query: function() {
                        ...
                        if (2 === arguments.length) {
                            ...
                            if (R(arguments[2], De) && arguments[0] instanceof Object && arguments[1] instanceof Fe)
                                for (var r = arguments[0], s = arguments[1], o = arguments[2], a = s.getChildBoundables(), u = 0; u < a.size(); u++) {
                                    var l = a.get(u);
                                    this.getIntersectsOp().intersects(l.getBounds(), r) && (l instanceof Fe ? this.query(r, l, o) : l instanceof _e ? o.visitItem(l.getItem()) : f.shouldNeverReachHere())
                                } else if (R(arguments[2], y) && arguments[0] instanceof Object && arguments[1] instanceof Fe)
                                    for (var h = arguments[0], c = arguments[1], g = arguments[2], a = c.getChildBoundables(), u = 0; u < a.size(); u++) {
                                        var l = a.get(u);
                                        this.getIntersectsOp().intersects(l.getBounds(), h) && (l instanceof Fe ? this.query(h, l, g) : l instanceof _e ? g.add(l.getItem()) : f.shouldNeverReachHere())
                                    }
                    },
                    build: function() {
                ...
                }), qe.compareDoubles = function(t, e) {
                    return t > e ? 1 : t < e ? -1 : 0
                }, qe.IntersectsOp = Be, qe.serialVersionUID = -0x35ef64c82d4c5400, qe.DEFAULT_NODE_CAPACITY = 10, e(ze.prototype, {
                    ...
                    size: function() {
                        return 0 === arguments.length ? qe.prototype.size.call(this) : qe.prototype.size.apply(this, arguments)
                    },
                    insert: function() {
                        if (2 !== arguments.length) return qe.prototype.insert.apply(this, arguments);
                        var t = arguments[0],
                            e = arguments[1];
                        return t.isNull() ? null : void qe.prototype.insert.call(this, t, e)
                    },
                    getIntersectsOp: function() {
                        return Ve.intersectsOp
                    },
                    ...
                    query: function() {
                        if (1 === arguments.length) {
                            var t = arguments[0];
                            return qe.prototype.query.call(this, t)
                        }
                        if (2 === arguments.length) {
                            var e = arguments[0],
                                n = arguments[1];
                            qe.prototype.query.call(this, e, n)
                        } else if (3 === arguments.length)
                            if (R(arguments[2], De) && arguments[0] instanceof Object && arguments[1] instanceof Fe) {
                                var i = arguments[0],
                                    r = arguments[1],
                                    s = arguments[2];
                                qe.prototype.query.call(this, i, r, s)
                            } else if (R(arguments[2], y) && arguments[0] instanceof Object && arguments[1] instanceof Fe) {
                            var o = arguments[0],
                                a = arguments[1],
                                u = arguments[2];
                            qe.prototype.query.call(this, o, a, u)
                        }
                    },
                    getComparator: function() {
                        return Ve.yComparator
                    },
                    createParentBoundablesFromVerticalSlice: function(t, e) {
                        return qe.prototype.createParentBoundables.call(this, t, e)
                    },
                    remove: function() {
                        if (2 === arguments.length) {
                            var t = arguments[0],
                                e = arguments[1];
                            return qe.prototype.remove.call(this, t, e)
                        }
                        return qe.prototype.remove.apply(this, arguments)
                    },
                    depth: function() {
                        return 0 === arguments.length ? qe.prototype.depth.call(this) : qe.prototype.depth.apply(this, arguments)
                    },
                    createParentBoundables: function(t, e) {
                        f.isTrue(!t.isEmpty());
                        var n = Math.trunc(Math.ceil(t.size() / this.getNodeCapacity())),
                            i = new I(t);
                        uo.sort(i, Ve.xComparator);
                    ...
                    nearestNeighbour: function() {
                        if (1 === arguments.length) {
                            ...
                            if (arguments[0] instanceof Ve && R(arguments[1], ze)) {
                                var i = arguments[0],
                                    s = arguments[1],
                                    e = new Ge(this.getRoot(), i.getRoot(), s);
                                return this.nearestNeighbour(e)
                            }
                ...
                }), Ve.centreX = function(t) {
                    return Ve.avg(t.getMinX(), t.getMaxX())
                }, Ve.avg = function(t, e) {
                    return (t + e) / 2
                }, Ve.centreY = function(t) {
                    return Ve.avg(t.getMinY(), t.getMaxY())
                }, h(ke, Fe), e(ke.prototype, {
                ...
                }), Ve.STRtreeNode = ke, Ve.serialVersionUID = 0x39920f7d5f261e0, Ve.xComparator = {
                    interfaces_: function() {
                        return [a]
                    },
                    compare: function(t, e) {
                        return qe.compareDoubles(Ve.centreX(t.getBounds()), Ve.centreX(e.getBounds()))
                    }
                }, Ve.yComparator = {
                    interfaces_: function() {
                        return [a]
                    ...
                    compare: function(t, e) {
                        return qe.compareDoubles(Ve.centreY(t.getBounds()), Ve.centreY(e.getBounds()))
                    }
                }, Ve.intersectsOp = {
                    interfaces_: function() {
                        return [IntersectsOp]
                ...
                }, Ve.DEFAULT_NODE_CAPACITY = 10, e(Ye.prototype, {
                    interfaces_: function() {
                        return []
                    },
                    getClass: function() {
                    ...
                    createSplitEdge: function(t, e) {
                        ...
                        return r && (s[o] = new g(e.coord)), new je(s, this.edge.getData())
                    },
                    add: function(t, e) {
                        var n = new Ue(this.edge, t, e, this.edge.getSegmentOctant(e)),
                ...
                }), je.getNodedSubstrings = function() {
                    if (1 === arguments.length) {
                        var t = arguments[0],
                            e = new I;
                        return je.getNodedSubstrings(t, e), e
                    }
                    if (2 === arguments.length)
                ...
                }, Qe.NE = 0, Qe.NW = 1, Qe.SW = 2, Qe.SE = 3, e(Je.prototype, {
                    interfaces_: function() {
                        return []
                    },
                    getClass: function() {
                    ...
                    n.add(new b(e));
                    do {
                        var i = Je.findChainEnd(t, e);
                        n.add(new b(i)), e = i
                    } while (e < t.length - 1);
                    return Je.toIntArray(n)
                    ...
                    for (var i = Qe.quadrant(t[n], t[n + 1]), r = e + 1; r < t.length;) {
                        if (!t[r - 1].equals2D(t[r])) {
                            if (Qe.quadrant(t[r - 1], t[r]) !== i) break
                        }
                        r++
                    }
                    return r - 1
                    ...
                    if (2 === arguments.length) {
                        for (var e = arguments[0], n = arguments[1], i = new I, r = Je.getChainStartIndices(e), s = 0; s < r.length - 1; s++) {
                            var o = new Ze(e, r[s], r[s + 1], n);
                            i.add(o)
                        }
                        return i
                    }
                    ...
                    getNodedSubstrings: function() {
                        return je.getNodedSubstrings(this.nodedSegStrings)
                    },
                    getIndex: function() {
                        return this.index
                    },
                    add: function(t) {
                        for (var e = Je.getChains(t.getCoordinates(), t), n = e.iterator(); n.hasNext();) {
                            var i = n.next();
                    ...
                    for (var e = new I, n = t.iterator(); n.hasNext();) {
                        var i = n.next();
                        e.add(new be(i.getCoordinates(), i))
                    }
                    return e
                    ...
                    for (var e = new fn(L.NONE), n = 0; n < 2; n++) e.setLocation(n, t.getLocation(n));
                    return e
                }, e(gn.prototype, {
                    ...
                    init: function(t, e) {
                        this.p0 = t, this.p1 = e, this.dx = e.x - t.x, this.dy = e.y - t.y, this.quadrant = Qe.quadrant(this.dx, this.dy), f.isTrue(!(0 === this.dx && 0 === this.dy), "EdgeEnd with identical endpoints found")
                    },
                    interfaces_: function() {
                        return [s]
                    },
                    ...
                    isInteriorAreaEdge: function() {
                        for (var t = !0, e = 0; e < 2; e++) this.label.isArea(e) && this.label.getLocation(e, hn.LEFT) === L.INTERIOR && this.label.getLocation(e, hn.RIGHT) === L.INTERIOR || (t = !1);
                        return t
                    },
                    ...
                    print: function(t) {
                        xn.prototype.print.call(this, t), t.print(" " + this.depth[hn.LEFT] + "/" + this.depth[hn.RIGHT]), t.print(" (" + this.getDepthDelta() + ")"), this._isInResult && t.print(" inResult")
                    },
                    ...
                    matchInSameDirection: function(t, e, n, i) {
                        return !!t.equals(n) && le.computeOrientation(t, e, i) === le.COLLINEAR && Qe.quadrant(t, e) === Qe.quadrant(n, i)
                    },
                ...
                }), Rn.isPointInRing = function(t, e) {
                    return !!e.getEnvelopeInternal().intersects(t) && le.isPointInRing(t, e.getCoordinates())
                }, Rn.containsPointInPolygon = function(t, e) {
                    if (e.isEmpty()) return !1;
                    var n = e.getExteriorRing();
                    if (!Rn.isPointInRing(t, n)) return !1;
                    for (var i = 0; i < e.getNumInteriorRing(); i++) {
                        var r = e.getInteriorRingN(i);
                        if (Rn.isPointInRing(t, r)) return !1
                    }
                    return !0
                }, Rn.containsPoint = function(t, e) {
                    if (e instanceof Tt) return Rn.containsPointInPolygon(t, e);
                    if (e instanceof ft)
                        for (var n = new Le(e); n.hasNext();) {
                            var i = n.next();
                            if (i !== e && Rn.containsPoint(t, i)) return !0
                        }
                    return !1
                }, Rn.locate = function(t, e) {
                    return e.isEmpty() ? L.EXTERIOR : Rn.containsPoint(t, e) ? L.INTERIOR : L.EXTERIOR
                }, e(Tn.prototype, {
                    ...
                    propagateSideLabels: function(t) {
                        for (var e = L.NONE, n = this.iterator(); n.hasNext();) {
                            var i = n.next(),
                                r = i.getLabel();
                            r.isArea(t) && r.getLocation(t, hn.LEFT) !== L.NONE && (e = r.getLocation(t, hn.LEFT))
                        }
                        if (e === L.NONE) return null;
                        for (var s = e, n = this.iterator(); n.hasNext();) {
                            var i = n.next(),
                                r = i.getLabel();
                            if (r.getLocation(t, hn.ON) === L.NONE && r.setLocation(t, hn.ON, s), r.isArea(t)) {
                                ...
                                } else f.isTrue(r.getLocation(t, hn.LEFT) === L.NONE, "found single null side"), r.setLocation(t, hn.RIGHT, s), r.setLocation(t, hn.LEFT, s)
                            }
                        }
                    },
                    getCoordinate: function() {
                    ...
                    getLocation: function(t, e, n) {
                        return this.ptInAreaLocation[t] === L.NONE && (this.ptInAreaLocation[t] = Rn.locate(e, n[t].getGeometry())), this.ptInAreaLocation[t]
                    },
                    toString: function() {
                        var t = new P;
                ...
                }), h(bn, In), e(bn.prototype, {
                    createNode: function(t) {
                        return new vn(t, new Pn)
                    },
                    interfaces_: function() {
                        return []
                    },
                ...
                }), _n.INSERT = 1, _n.DELETE = 2, e(Mn.prototype, {
                    interfaces_: function() {
                        return []
                    },
                    getClass: function() {
                ...
                }), Fn.NodeComparator = Gn, h(qn, Fn), e(qn.prototype, {
                ...
                }), Vn.getGeometry = function() {
                    if (1 === arguments.length) {
                        var t = arguments[0];
                        return t.getFactory().buildGeometry(Vn.getLines(t))
                    }
                    if (2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1];
                        return e.getFactory().buildGeometry(Vn.getLines(e, n))
                    }
                }, Vn.getLines = function() {
                    if (1 === arguments.length) {
                        var t = arguments[0];
                        return Vn.getLines(t, !1)
                    }
                    if (2 === arguments.length) {
                        ...
                        if (arguments[0] instanceof B && "boolean" == typeof arguments[1]) {
                            var s = arguments[0],
                                o = arguments[1],
                                a = new I;
                            return s.apply(new Vn(a, o)), a
                        }
                        if (arguments[0] instanceof B && R(arguments[1], m)) {
                            var u = arguments[0],
                                l = arguments[1];
                            return u instanceof St ? l.add(u) : u.apply(new Vn(l)), l
                        }
                    } else if (3 === arguments.length) {
                        ...
                        if ("boolean" == typeof arguments[2] && arguments[0] instanceof B && R(arguments[1], m)) {
                            var g = arguments[0],
                                d = arguments[1],
                                p = arguments[2];
                            return g.apply(new Vn(d, p)), d
                        }
                    }
                }, e(kn.prototype, {
                    visitItem: function(t) {
                    ...
                    init: function(t) {
                        for (var e = Vn.getLines(t), n = e.iterator(); n.hasNext();) {
                            var i = n.next(),
                                r = i.getCoordinates();
                            this.addLine(r)
                        }
                ...
                }), Yn.SegmentVisitor = Un, Yn.IntervalIndexedGeometry = Xn, e(Hn.prototype, {
                    ...
                    isNull: function() {
                        if (0 === arguments.length) {
                            for (var t = 0; t < 2; t++)
                                for (var e = 0; e < 3; e++)
                                    if (this.depth[t][e] !== Zn.NULL_VALUE) return !1;
                            return !0
                        }
                        if (1 === arguments.length) {
                            var n = arguments[0];
                            return this.depth[n][1] === Zn.NULL_VALUE
                        }
                        if (2 === arguments.length) {
                            var i = arguments[0],
                                r = arguments[1];
                            return this.depth[i][r] === Zn.NULL_VALUE
                        }
                    },
                    normalize: function() {
                        for (var t = 0; t < 2; t++)
                        ...
                        if (1 === arguments.length)
                            for (var t = arguments[0], e = 0; e < 2; e++)
                                for (var n = 1; n < 3; n++) {
                                    ...
                                    i !== L.EXTERIOR && i !== L.INTERIOR || (this.isNull(e, n) ? this.depth[e][n] = Zn.depthAtLocation(i) : this.depth[e][n] += Zn.depthAtLocation(i))
                                } else if (3 === arguments.length) {
                                    var r = arguments[0],
                                        s = arguments[1],
                                        o = arguments[2];
                ...
                }), Zn.depthAtLocation = function(t) {
                    return t === L.EXTERIOR ? 0 : t === L.INTERIOR ? 1 : Zn.NULL_VALUE
                }, Zn.NULL_VALUE = -1, h(Qn, mn), e(Qn.prototype, {
                    getDepth: function() {
                        return this.depth
                    },
                    getCollapsedEdge: function() {
                        var t = new Array(2).fill(null);
                        return t[0] = this.pts[0], t[1] = this.pts[1], new Qn(t, fn.toLineLabel(this.label))
                    },
                    isIsolated: function() {
                ...
                }, h(Jn, Nn), e(Jn.prototype, {
                    insertBoundaryPoint: function(t, e) {
                        var n = this.nodes.addNode(e),
                            i = n.getLabel(),
                            r = 1;
                        L.NONE;
                        i.getLocation(t, hn.ON) === L.BOUNDARY && r++;
                        var s = Jn.determineBoundary(this.boundaryNodeRule, r);
                        i.setLocation(t, s)
                    },
                ...
                }), Jn.determineBoundary = function(t, e) {
                    ...
                    computeOverlay: function(t) {
                        ...
                        var r = new wn(this, this.geomFact, this.ptLocator);
                    ...
                    selfSnap: function(t) {
                        return new Ee(t).snapTo(t, this.snapTolerance)
                    },
                    removeCommonBits: function(t) {
                    ...
                    computeSnapTolerance: function() {
                        this.snapTolerance = Ee.computeOverlaySnapTolerance(this.geom[0], this.geom[1])
                    },
                    snap: function(t) {
                        var e = this.removeCommonBits(t);
                        return Ee.snap(e[0], e[1], this.snapTolerance)
                    },
                    interfaces_: function() {
                        return []
                    },
                ...
                mi.isZeroWidth = function(t, e) {
                    ...
                    buildIndex: function() {
                        this.tree = new yi;
                        for (var t = H.removeRepeatedPoints(this.ring.getCoordinates()), e = Je.getChains(t), n = 0; n < e.size(); n++) {
                            var i = e.get(n),
                                r = i.getEnvelope();
                ...
                }), Ei.MCSelecter = Ii, e(Ni.prototype, {
                    interfaces_: function() {
                        return []
                    },
                    getClass: function() {
                    ...
                    computeCirclePoints: function() {
                        ...
                        for (var i = Si.lowestPoint(t), r = Si.pointWitMinAngleWithX(t, i), s = 0; s < t.length; s++) {
                            var o = Si.pointWithMinAngleWithSegment(t, i, r);
                ...
                }), Si.pointWitMinAngleWithX = function(t, e) {
                    ...
                    return i
                }, Si.lowestPoint = function(t) {
                    for (var e = t[0], n = 1; n < t.length; n++) t[n].y < e.y && (e = t[n]);
                    return e
                }, Si.pointWithMinAngleWithSegment = function(t, e, n) {
                    ...
                    findMaxPerpDistance: function(t, e, n) {
                        for (var i = e.distancePerpendicular(t[n]), r = i, s = n, o = s; r >= i;) i = r, s = o, o = wi.nextIndex(t, s), r = e.distancePerpendicular(t[o]);
                    ...
                    getMinimumRectangle: function() {
                        ...
                        for (var t = this.minBaseSeg.p1.x - this.minBaseSeg.p0.x, e = this.minBaseSeg.p1.y - this.minBaseSeg.p0.y, n = r.MAX_VALUE, i = -r.MAX_VALUE, s = r.MAX_VALUE, o = -r.MAX_VALUE, a = 0; a < this.convexHullPts.length; a++) {
                            var u = wi.computeC(t, e, this.convexHullPts[a]);
                            u > i && (i = u), u < n && (n = u);
                            var l = wi.computeC(-e, t, this.convexHullPts[a]);
                            l > o && (o = l), l < s && (s = l)
                        }
                        var h = wi.computeSegmentForLine(-t, -e, o),
                            c = wi.computeSegmentForLine(-t, -e, s),
                            f = wi.computeSegmentForLine(-e, t, i),
                            g = wi.computeSegmentForLine(-e, t, n),
                ...
                }), wi.nextIndex = function(t, e) {
                    return e++, e >= t.length && (e = 0), e
                }, wi.computeC = function(t, e, n) {
                    return t * n.y - e * n.x
                }, wi.getMinimumDiameter = function(t) {
                    return new wi(t).getDiameter()
                }, wi.getMinimumRectangle = function(t) {
                    return new wi(t).getMinimumRectangle()
                }, wi.computeSegmentForLine = function(t, e, n) {
                    var i = null,
                        r = null;
                ...
                e(Li.prototype, {
                    getResultGeometry: function() {
                        return new Ri(this.distanceTolerance).transform(this.inputGeom)
                    },
                ...
                }), Li.densifyPoints = function(t, e, n) {
                    ...
                    transformCoordinates: function(t, e) {
                        var n = t.toCoordinateArray(),
                            i = Li.densifyPoints(n, this.distanceTolerance, e.getPrecisionModel());
                ...
                e(Ti.prototype, {
                ...
                }), Pi.setMarkBoth = function(t, e) {
                    t.setMark(e), t.sym().setMark(e)
                }, Pi.isMarked = function(t) {
                    return t.isMarked()
                }, Pi.setMark = function(t, e) {
                    t.setMark(e)
                }, Pi.markBoth = function(t) {
                    t.mark(), t.sym().mark()
                }, Pi.mark = function(t) {
                    t.mark()
                }, e(bi.prototype, {
                    ...
                    create: function(t, e) {
                        var n = this.createEdge(t),
                            i = this.createEdge(e);
                        return Ti.init(n, i), n
                    },
                    createEdge: function(t) {
                        return new Ti(t)
                    },
                    addEdge: function(t, e) {
                        if (!bi.isValidEdge(t, e)) return null;
                ...
                }), bi.isValidEdge = function(t, e) {
                    return 0 !== e.compareTo(t)
                }, h(Oi, Pi), e(Oi.prototype, {
                    setStart: function() {
                        this._isStart = !0
                    },
                    isStart: function() {
                    ...
                    buildLine: function(t) {
                        var e = new N,
                            n = t;
                        for (this.ringStartEdge = null, Pi.markBoth(n), e.add(n.orig().copy(), !1); 2 === n.sym().degree();) {
                            this.updateRingStartEdge(n);
                            var i = n.next();
                            if (i === t) return this.buildRing(this.ringStartEdge), null;
                            e.add(i.orig().copy(), !1), n = i, Pi.markBoth(n)
                        }
                    ...
                    stackEdges: function(t) {
                        var e = t;
                        do {
                            Pi.isMarked(e) || this.nodeEdgeStack.add(e), e = e.oNext()
                        } while (e !== t)
                    },
                    computeResult: function() {
                        for (var t = this.graph.getVertexEdges(), e = t.iterator(); e.hasNext();) {
                            var n = e.next();
                            Pi.isMarked(n) || this.process(n)
                        }
                    ...
                    buildLines: function() {
                        for (; !this.nodeEdgeStack.empty();) {
                            ...
                            Pi.isMarked(t) || this.buildLine(t)
                        }
                    },
                    add: function() {
                        if (arguments[0] instanceof B) {
                ...
                }, h(Gi, Di), e(Gi.prototype, {
                    insert: function(t, e) {
                        var n = Di.getSubnodeIndex(t, Gi.origin.x, Gi.origin.y);
                        if (-1 === n) return this.add(e), null;
                        var i = this.subnode[n];
                ...
                }), Gi.origin = new g(0, 0), e(qi.prototype, {
                    size: function() {
                        return null !== this.root ? this.root.size() : 0
                    },
                    insert: function(t, e) {
                        this.collectStats(t);
                        var n = qi.ensureExtent(t, this.minExtent);
                        this.root.insert(n, e)
                    },
                    query: function() {
                        if (1 === arguments.length) {
                ...
                }), qi.ensureExtent = function(t, e) {
                    var n = t.getMinX(),
                        i = t.getMaxX(),
                        r = t.getMinY(),
                        s = t.getMaxY();
                    return n !== i && r !== s ? t : (n === i && (n -= e / 2, i = n + e / 2), r === s && (r -= e / 2, s = r + e / 2), new C(n, i, r, s))
                }, qi.serialVersionUID = -0x678b60c967a25400;
                ...
                var yo = {
                    ...
                    xo = {
                        ...
                        Point: function(t) {
                            return {
                                type: "Point",
                                coordinates: xo.coordinate.apply(this, [t.getCoordinate()])
                            }
                        },
                        MultiPoint: function(t) {
                            for (var e = [], n = 0; n < t.geometries.length; ++n) {
                                var i = t.geometries[n],
                                    r = xo.Point.apply(this, [i]);
                        ...
                        LineString: function(t) {
                            for (var e = [], n = t.getCoordinates(), i = 0; i < n.length; ++i) {
                                var r = n[i];
                                e.push(xo.coordinate.apply(this, [r]))
                            }
                            return {
                                type: "LineString",
                                coordinates: e
                        ...
                        Polygon: function(t) {
                            var e = [],
                                n = xo.LineString.apply(this, [t.shell]);
                            e.push(n.coordinates);
                            for (var i = 0; i < t.holes.length; ++i) {
                                var r = t.holes[i],
                                    s = xo.LineString.apply(this, [r]);
                ...
                e(zi.prototype, {
                    ...
                    convertToLineString: function(t) {
                        var e = t.points.coordinates.map(Yi);
                    ...
                    convertToPolygon: function(t) {
                        for (var e = [t.shell.points.coordinates.map(Yi)], n = 0; n < t.holes.length; n++) e.push(t.holes[n].points.coordinates.map(Yi));
                        return new this.ol.geom.Polygon(e)
                    },
                    convertToMultiPoint: function(t) {
                        return new this.ol.geom.MultiPoint(t.getCoordinates().map(Yi))
                    },
                    ...
                    scale: function() {
                        if (R(arguments[0], m)) {
                            for (var t = arguments[0], e = new I, n = t.iterator(); n.hasNext();) {
                                var i = n.next();
                                e.add(new je(this.scale(i.getCoordinates()), i.getData()))
                            }
                            return e
                        }
                        if (arguments[0] instanceof Array) {
                ...
                e(Hi.prototype, {
                    ...
                    addEndpoint: function(t, e, n) {
                        var i = t.get(e);
                        null === i && (i = new Wi(e), t.put(e, i)), i.addEndpoint(n)
                    },
                ...
                }), Hi.EndpointInfo = Wi, e(ji.prototype, {
                    ...
                    setQuadrantSegments: function(t) {
                        this.quadrantSegments = t, 0 === this.quadrantSegments && (this.joinStyle = ji.JOIN_BEVEL), this.quadrantSegments < 0 && (this.joinStyle = ji.JOIN_MITRE, this.mitreLimit = Math.abs(this.quadrantSegments)), t <= 0 && (this.quadrantSegments = 1), this.joinStyle !== ji.JOIN_ROUND && (this.quadrantSegments = ji.DEFAULT_QUADRANT_SEGMENTS)
                    },
                ...
                }), ji.bufferDistanceError = function(t) {
                    var e = Math.PI / 2 / t;
                    return 1 - Math.cos(e / 2)
                }, ji.CAP_ROUND = 1, ji.CAP_FLAT = 2, ji.CAP_SQUARE = 3, ji.JOIN_ROUND = 1, ji.JOIN_MITRE = 2, ji.JOIN_BEVEL = 3, ji.DEFAULT_QUADRANT_SEGMENTS = 8, ji.DEFAULT_MITRE_LIMIT = 5, ji.DEFAULT_SIMPLIFY_FACTOR = .01, e(Ki.prototype, {
                    getCoordinate: function() {
                ...
                }), Zi.prototype.addLast = function(t) {
                    this.array_.push(t)
                }, Zi.prototype.removeFirst = function() {
                    ...
                    deleteShallowConcavities: function() {
                        for (var t = 1, e = (this.inputLine.length, this.findNextNonDeletedIndex(t)), n = this.findNextNonDeletedIndex(e), i = !1; n < this.inputLine.length;) {
                            var r = !1;
                            this.isDeletable(t, e, n, this.distanceTol) && (this.isDeleted[e] = Ji.DELETE, r = !0, i = !0), t = r ? n : e, e = this.findNextNonDeletedIndex(t), n = this.findNextNonDeletedIndex(e)
                        }
                        return i
                    },
                    ...
                    isShallowSampled: function(t, e, n, i, r) {
                        var s = Math.trunc((i - n) / Ji.NUM_PTS_TO_CHECK);
                        s <= 0 && (s = 1);
                        for (var o = n; o < i; o += s)
                    ...
                    findNextNonDeletedIndex: function(t) {
                        for (var e = t + 1; e < this.inputLine.length && this.isDeleted[e] === Ji.DELETE;) e++;
                        return e
                    },
                    ...
                    collapseLine: function() {
                        for (var t = new N, e = 0; e < this.inputLine.length; e++) this.isDeleted[e] !== Ji.DELETE && t.add(this.inputLine[e]);
                        return t.toCoordinateArray()
                    },
                    interfaces_: function() {
                        return []
                ...
                }), Ji.simplify = function(t, e) {
                    return new Ji(t).simplify(e)
                }, Ji.INIT = 0, Ji.DELETE = 1, Ji.KEEP = 1, Ji.NUM_PTS_TO_CHECK = 10, e($i.prototype, {
                    getCoordinates: function() {
                    ...
                    addInsideTurn: function(t, e) {
                        if (this.li.computeIntersection(this.offset0.p0, this.offset0.p1, this.offset1.p0, this.offset1.p1), this.li.hasIntersection()) this.segList.addPt(this.li.getIntersection(0));
                            ...
                            this.offset0.p1.distance(this.offset1.p0) < this.distance * tr.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR) this.segList.addPt(this.offset0.p1);
                        else {
                    ...
                    addCollinear: function(t) {
                        this.li.computeIntersection(this.s0, this.s1, this.s1, this.s2), this.li.getIntersectionNum() >= 2 && (this.bufParams.getJoinStyle() === ji.JOIN_BEVEL || this.bufParams.getJoinStyle() === ji.JOIN_MITRE ? (t && this.segList.addPt(this.offset0.p1), this.segList.addPt(this.offset1.p0)) : this.addFilletCorner(this.s1, this.offset0.p1, this.offset1.p0, le.CLOCKWISE, this.distance))
                    },
                    closeRing: function() {
                    ...
                    findStabbedSegments: function() {
                        ...
                        if (3 === arguments.length)
                            if (R(arguments[2], y) && arguments[0] instanceof g && arguments[1] instanceof En)
                    ...
                    addCurve: function(t, e, n) {
                        ...
                        var i = new je(t, new fn(0, L.BOUNDARY, e, n));
                    ...
                    addPolygonRing: function(t, e, n, i, r) {
                        ...
                        var s = i,
                            o = r;
                        t.length >= bt.MINIMUM_VALID_SIZE && le.isCCW(t) && (s = r, o = i, n = hn.opposite(n));
                    ...
                    buffer: function(t, e) {
                        ...
                        this.computeNodedEdges(s, n), this.graph = new Nn(new bn), this.graph.addEdges(this.edgeList.getEdges());
                    ...
                    if (3 === arguments.length) {
                        ...
                        if (arguments[2] instanceof ji && arguments[0] instanceof B && "number" == typeof arguments[1]) {
                            var u = arguments[0],
                                l = arguments[1],
                                h = arguments[2],
                                a = new gr(u, h),
                ...
                }, gr.CAP_ROUND = ji.CAP_ROUND, gr.CAP_BUTT = ji.CAP_FLAT, gr.CAP_FLAT = ji.CAP_FLAT, gr.CAP_SQUARE = ji.CAP_SQUARE, gr.MAX_PRECISION_DIGITS = 12;
                ...
                e(dr.prototype, {
                    ...
                    if (2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1];
                        return e instanceof Tt ? n.add(e) : e instanceof ft && e.apply(new dr(n)), n
                    }
                }, e(pr.prototype, {
                    ...
                    if (1 === arguments.length) {
                        var t = arguments[0];
                        return t instanceof Lt ? uo.singletonList(t) : mr.getPoints(t, new I)
                    }
                    if (2 === arguments.length) {
                        var e = arguments[0],
                            n = arguments[1];
                    ...
                    filter: function(t) {
                        (t instanceof Lt || t instanceof St || t instanceof Tt) && this.locations.add(new pr(t, 0, t.getCoordinate()))
                    },
                    interfaces_: function() {
                        return [ht]
                    },
                    ...
                    computeContainmentDistance: function() {
                        if (0 === arguments.length) {
                            ...
                            } else if (arguments[2] instanceof Array && arguments[0] instanceof pr && arguments[1] instanceof Tt) {
                            var f = arguments[0],
                                g = arguments[1],
                                d = arguments[2],
                                p = f.getCoordinate();
                            if (L.EXTERIOR !== this.ptLocator.locate(p, g)) return this.minDistance = 0, d[0] = f, d[1] = new pr(g, p), null
                        }
                    },
                    ...
                    computeFacetDistance: function() {
                        var t = new Array(2).fill(null),
                            e = Vn.getLines(this.geom[0]),
                            n = Vn.getLines(this.geom[1]),
                ...
                e(xr.prototype, {
                ...
                }), Er.getComponentWithVisitedState = function(t, e) {
                    for (; t.hasNext();) {
                        var n = t.next();
                        if (n.isVisited() === e) return n
                    }
                    return null
                }, Er.setVisited = function(t, e) {
                    for (; t.hasNext();) {
                        t.next().setVisited(e)
                    }
                }, Er.setMarked = function(t, e) {
                    for (; t.hasNext();) {
                        t.next().setMarked(e)
                    }
                    ...
                    getNode: function(t) {
                        ...
                        return null === e && (e = new wr(t), this.add(e)), e
                    },
                    interfaces_: function() {
                        return []
                    },
                    ...
                    merge: function() {
                        ...
                        Er.setMarked(this.graph.nodeIterator(), !1), Er.setMarked(this.graph.edgeIterator(), !1), this.edgeStrings = new I, this.buildEdgeStringsForObviousStartNodes(), this.buildEdgeStringsForIsolatedLoops(), this.mergedLineStrings = new I;
                ...
                h(Or, Ir), e(Or.prototype, {
                        ...
                        visitInteriorRing: function(t, e) {
                            var n = t.getCoordinates(),
                                ...
                                o = e.findEdgeEnd(s),
                                a = null;
                            o.getLabel().getLocation(0, hn.RIGHT) === L.INTERIOR ? a = o : o.getSym().getLabel().getLocation(0, hn.RIGHT) === L.INTERIOR && (a = o.getSym()), f.isTrue(null !== a, "unable to find dirEdge with Interior on RHS"), this.visitLinkedDirectedEdges(a)
                        },
                        ...
                        hasUnvisitedShellEdge: function(t) {
                            for (var e = 0; e < t.size(); e++) {
                                ...
                                if (!n.isHole()) {
                                    var i = n.getEdges(),
                                        r = i.get(0);
                                    if (r.getLabel().getLocation(0, hn.RIGHT) === L.INTERIOR)
                        ...
                        computeLabelOn: function(t, e) {
                            ...
                            var o = L.NONE;
                            i && (o = L.INTERIOR), n > 0 && (o = Jn.determineBoundary(e, n)), this.label.setLocation(t, o)
                        },
                        ...
                        computeLabel: function(t) {
                            ...
                            this.label = e ? new fn(L.NONE, L.NONE, L.NONE) : new fn(L.NONE);
                            ...
                            for (var t = 0; t < this.rings.size(); t++)
                                for (var e = this.rings.get(t), n = e.getCoordinates(), i = this.index.query(e.getEnvelopeInternal()), r = 0; r < i.size(); r++) {
                                    ...
                                    if (e !== s && e.getEnvelopeInternal().intersects(s.getEnvelopeInternal())) {
                                        var a = Yr.findPtNotNode(n, s, this.graph);
                                        if (null !== a) {
                        ...
                        getMessage: function() {
                            return kr.errMsg[this.errorType]
                        },
                        getCoordinate: function() {
                            return this.pt
                        },
                    ...
                    }), kr.ERROR = 0, kr.REPEATED_POINT = 1, kr.HOLE_OUTSIDE_SHELL = 2, kr.NESTED_HOLES = 3, kr.DISCONNECTED_INTERIOR = 4, kr.SELF_INTERSECTION = 5, kr.RING_SELF_INTERSECTION = 6, kr.NESTED_SHELLS = 7, kr.DUPLICATE_RINGS = 8, kr.TOO_FEW_POINTS = 9, kr.INVALID_COORDINATE = 10, kr.RING_NOT_CLOSED = 11, kr.errMsg = ["Topology Validation Error", "Repeated Point", "Hole lies outside shell", "Holes are nested", "Interior is disconnected", "Self-intersection", "Ring Self-intersection", "Nested shells", "Duplicate Rings", "Too few distinct points in geometry component", "Invalid Coordinate", "Ring is not closed"], e(Yr.prototype, {
                        checkInvalidCoordinates: function() {
                            if (arguments[0] instanceof Array) {
                                for (var t = arguments[0], e = 0; e < t.length; e++)
                                    if (!Yr.isValid(t[e])) return this.validErr = new kr(kr.INVALID_COORDINATE, t[e]), null
                        ...
                        checkHolesNotNested: function(t, e) {
                            for (var n = new Vr(e), i = 0; i < t.getNumInteriorRing(); i++) {
                                var r = t.getInteriorRingN(i);
                                n.add(r)
                            }
                            n.isNonNested() || (this.validErr = new kr(kr.NESTED_HOLES, n.getNestedPoint()))
                        },
                        checkConsistentArea: function(t) {
                            var e = new zr(t);
                            return e.isNodeConsistentArea() ? void(e.hasDuplicateRings() && (this.validErr = new kr(kr.DUPLICATE_RINGS, e.getInvalidPoint()))) : (this.validErr = new kr(kr.SELF_INTERSECTION, e.getInvalidPoint()), null)
                        },
                        isValid: function() {
                        ...
                        checkShellInsideHole: function(t, e, n) {
                            var i = t.getCoordinates(),
                                r = e.getCoordinates(),
                                s = Yr.findPtNotNode(i, e, n);
                            if (null !== s) {
                                if (!le.isPointInRing(s, r)) return s
                            }
                            var o = Yr.findPtNotNode(r, t, n);
                            if (null !== o) {
                        ...
                        checkConnectedInteriors: function(t) {
                            var e = new Mr(t);
                            e.isInteriorsConnected() || (this.validErr = new kr(kr.DISCONNECTED_INTERIOR, e.getCoordinate()))
                        },
                        checkNoSelfIntersectingRing: function(t) {
                            for (var e = new at, n = !0, i = t.iterator(); i.hasNext();) {
                                ...
                                if (n) n = !1;
                                    ...
                                    if (e.contains(r.coord)) return this.validErr = new kr(kr.RING_SELF_INTERSECTION, r.coord), null;
                                    e.add(r.coord)
                                }
                            }
                        },
                        checkHolesInShell: function(t, e) {
                            for (var n = t.getExteriorRing(), i = new Ei(n), r = 0; r < t.getNumInteriorRing(); r++) {
                                var s = t.getInteriorRingN(r),
                                    o = Yr.findPtNotNode(s.getCoordinates(), n, e);
                                if (null === o) return null;
                                if (!i.isInside(o)) return this.validErr = new kr(kr.HOLE_OUTSIDE_SHELL, o), null
                            }
                        },
                        checkTooFewPoints: function(t) {
                            if (t.hasTooFewPoints()) return this.validErr = new kr(kr.TOO_FEW_POINTS, t.getInvalidPoint()), null
                        },
                        ...
                        checkShellNotNested: function(t, e, n) {
                            var i = t.getCoordinates(),
                                r = e.getExteriorRing(),
                                s = r.getCoordinates(),
                                o = Yr.findPtNotNode(i, r, n);
                            if (null === o) return null;
                            if (!le.isPointInRing(o, s)) return null;
                            if (e.getNumInteriorRing() <= 0) return this.validErr = new kr(kr.NESTED_SHELLS, o), null;
                            ...
                            this.validErr = new kr(kr.NESTED_SHELLS, a)
                        },
                        ...
                        checkClosedRing: function(t) {
                            if (!t.isClosed()) {
                                var e = null;
                                t.getNumPoints() >= 1 && (e = t.getCoordinateN(0)), this.validErr = new kr(kr.RING_NOT_CLOSED, e)
                            }
                        },
                    ...
                    }), Yr.findPtNotNode = function(t, e, n) {
                        ...
                        if (arguments[0] instanceof B) {
                            return new Yr(arguments[0]).isValid()
                        }
                        if (arguments[0] instanceof g) {
                            var t = arguments[0];
                        ...
                        getCoordinates: function() {
                            if (null === this.ringPts) {
                                for (var t = new N, e = this.deList.iterator(); e.hasNext();) {
                                    var n = e.next(),
                                        i = n.getEdge();
                                    Ur.addEdge(i.getLine().getCoordinates(), n.getEdgeDirection(), t)
                                }
                        ...
                        isValid: function() {
                            return this.getCoordinates(), !(this.ringPts.length <= 3) && (this.getRing(), Yr.isValid(this.ring))
                        },
                        build: function(t) {
                            var e = t;
                            do {
                    ...
                    }), Ur.findDirEdgesInRing = function(t) {
                        var e = t,
                            n = new I;
                        do {
                    ...
                    }), Ur.EnvelopeComparator = Xr, h(Hr, Tr), e(Hr.prototype, {
                        findEdgeRing: function(t) {
                            var e = new Ur(this.factory);
                            return e.build(t), e
                        },
                        ...
                        deleteDangles: function() {
                            for (var t = this.findNodesOfDegree(1), e = new J, n = new de, i = t.iterator(); i.hasNext();) n.push(i.next());
                            for (; !n.isEmpty();) {
                                var r = n.pop();
                                Hr.deleteAllEdges(r);
                        ...
                        polygonize: function() {
                            ...
                            var t = this.graph.getEdgeRings(),
                                e = new I;
                            this.invalidRingLines = new I, this.isCheckingRingsValid ? this.findValidRings(t, e, this.invalidRingLines) : e = t, this.findShellsAndHoles(e), Wr.assignHolesToShells(this.holeList, this.shellList), uo.sort(this.shellList, new Ur.EnvelopeComparator);
                            var n = !0;
                            this.extractOnlyPolygonal && (Wr.findDisjointShells(this.shellList), n = !1), this.polyList = Wr.extractPolygons(this.shellList, n)
                        },
                        getDangles: function() {
                    ...
                    Wr.extractPolygons = function(t, e) {
                        for (var n = new I, i = t.iterator(); i.hasNext();) {
                            var r = i.next();
                            (e || r.isIncluded()) && n.add(r.getPolygon())
                        }
                        return n
                    }, Wr.assignHolesToShells = function(t, e) {
                        for (var n = t.iterator(); n.hasNext();) {
                            var i = n.next();
                            Wr.assignHoleToShell(i, e)
                        }
                    }, Wr.assignHoleToShell = function(t, e) {
                        var n = Ur.findEdgeRingContaining(t, e);
                        null !== n && n.addHole(t)
                    }, Wr.findDisjointShells = function(t) {
                ...
                e(Kr.prototype, {
                ...
                }), Zr.contains = function(t, e) {
                    return new Zr(t).contains(e)
                }, e(Qr.prototype, {
                    intersects: function(t, e) {
                        var n = new C(t, e);
                    ...
                    visit: function(t) {
                        ...
                        for (var n = new g, i = 0; i < 4; i++)
                            if (this.rectSeq.getCoordinate(i, n), e.contains(n) && Rn.containsPointInPolygon(n, t)) return this._containsPoint = !0, null
                    },
                    ...
                    return !!t.getEnvelopeInternal().contains(e.getEnvelopeInternal()) && (t.isRectangle() ? Zr.contains(t, e) : is.relate(t, e).isContains())
                };
                ...
                e(rs.prototype, {
                    ...
                    union: function() {
                        for (var t = new Re, e = new at, n = 0; n < this.pointGeom.getNumGeometries(); n++) {
                    ...
                    union: function() {
                        ...
                        for (var t = new Ve(as.STRTREE_NODE_CAPACITY), e = this.inputPolys.iterator(); e.hasNext();) {
                            var n = e.next();
                ...
                h(ls, _t.CoordinateOperation), e(ls.prototype, {
                    ...
                    reducePointwise: function(t) {
                        ...
                        if (this.changePrecisionModel) {
                            e = new _t(this.createFactory(t.getFactory(), this.targetPM))
                        } else e = new _t;
                    ...
                    createEditor: function(t, e) {
                        return t.getPrecisionModel() === e ? new _t : new _t(this.createFactory(t, e))
                    },
                    interfaces_: function() {
                        return []
                    },
                ...
                }), Es.LineStringTransformer = Is, Es.LineStringMapBuilderFilter = Ns;
                var _o = Object.freeze({
                    DouglasPeuckerSimplifier: fs,
                    TopologyPreservingSimplifier: Es
                });
                e(Cs.prototype, {
                    splitAt: function() {
                        if (1 === arguments.length) {
                ...
                }), ws.projectedSplitPoint = function(t, e) {
                ...
                }), Ls.triArea = function(t, e, n) {
                    return (e.x - t.x) * (n.y - t.y) - (e.y - t.y) * (n.x - t.x)
                }, Ls.isInCircleDDNormalized = function(t, e, n, i) {
                ...
                }, Ls.checkRobustInCircle = function(t, e, n, i) {
                    var r = Ls.isInCircleNonRobust(t, e, n, i),
                        s = Ls.isInCircleDDSlow(t, e, n, i),
                        o = Ls.isInCircleCC(t, e, n, i),
                ...
                }, Ls.isInCircleDDFast = function(t, e, n, i) {
                    var r = _.sqr(t.x).selfAdd(_.sqr(t.y)).selfMultiply(Ls.triAreaDDFast(e, n, i)),
                        s = _.sqr(e.x).selfAdd(_.sqr(e.y)).selfMultiply(Ls.triAreaDDFast(t, n, i)),
                        o = _.sqr(n.x).selfAdd(_.sqr(n.y)).selfMultiply(Ls.triAreaDDFast(t, e, i)),
                        a = _.sqr(i.x).selfAdd(_.sqr(i.y)).selfMultiply(Ls.triAreaDDFast(t, e, n));
                    return r.selfSubtract(s).selfAdd(o).selfSubtract(a).doubleValue() > 0
                }, Ls.isInCircleCC = function(t, e, n, i) {
                    var r = Ci.circumcentre(t, e, n),
                        s = t.distance(r);
                    return i.distance(r) - s <= 0
                }, Ls.isInCircleNormalized = function(t, e, n, i) {
                    var r = t.x - i.x,
                        s = t.y - i.y,
                        o = e.x - i.x,
                        a = e.y - i.y,
                ...
                }, Ls.isInCircleDDSlow = function(t, e, n, i) {
                    var r = _.valueOf(i.x),
                        s = _.valueOf(i.y),
                        o = _.valueOf(t.x),
                        a = _.valueOf(t.y),
                        ...
                        h = _.valueOf(n.x),
                        c = _.valueOf(n.y),
                        f = o.multiply(o).add(a.multiply(a)).multiply(Ls.triAreaDDSlow(u, l, h, c, r, s)),
                        g = u.multiply(u).add(l.multiply(l)).multiply(Ls.triAreaDDSlow(o, a, h, c, r, s)),
                        d = h.multiply(h).add(c.multiply(c)).multiply(Ls.triAreaDDSlow(o, a, u, l, r, s)),
                        p = r.multiply(r).add(s.multiply(s)).multiply(Ls.triAreaDDSlow(o, a, u, l, h, c));
                    return f.subtract(g).add(d).subtract(p).doubleValue() > 0
                }, Ls.isInCircleNonRobust = function(t, e, n, i) {
                    return (t.x * t.x + t.y * t.y) * Ls.triArea(e, n, i) - (e.x * e.x + e.y * e.y) * Ls.triArea(t, n, i) + (n.x * n.x + n.y * n.y) * Ls.triArea(t, e, i) - (i.x * i.x + i.y * i.y) * Ls.triArea(t, e, n) > 0
                }, Ls.isInCircleRobust = function(t, e, n, i) {
                    return Ls.isInCircleNormalized(t, e, n, i)
                }, Ls.triAreaDDSlow = function(t, e, n, i, r, s) {
                    return n.subtract(t).multiply(s.subtract(e)).subtract(i.subtract(e).multiply(r.subtract(t)))
                }, Ls.triAreaDDFast = function(t, e, n) {
                    ...
                    circleCenter: function(t, e) {
                        var n = new Rs(this.getX(), this.getY()),
                            i = this.bisector(n, t),
                            r = this.bisector(t, e),
                            s = new F(i, r),
                            o = null;
                        try {
                            o = new Rs(s.getX(), s.getY())
                        } catch (i) {
                    ...
                    isInCircle: function(t, e, n) {
                        return Ls.isInCircleRobust(t.p, e.p, n.p, this.p)
                    },
                    ...
                    midPoint: function(t) {
                        return new Rs((this.p.x + t.getX()) / 2, (this.p.y + t.getY()) / 2, (this.p.z + t.getZ()) / 2)
                    },
                    rightOf: function(t) {
                    ...
                    times: function(t) {
                        return new Rs(t * this.p.x, t * this.p.y)
                    },
                    cross: function() {
                        return new Rs(this.p.y, -this.p.x)
                    },
                    leftOf: function(t) {
                    ...
                    sub: function(t) {
                        return new Rs(this.p.x - t.getX(), this.p.y - t.getY())
                    },
                    getY: function() {
                        return this.p.y
                    },
                    classify: function(t, e) {
                        var n = this,
                            ...
                            r = n.sub(t),
                            s = i.crossProduct(r);
                        return s > 0 ? Rs.LEFT : s < 0 ? Rs.RIGHT : i.getX() * r.getX() < 0 || i.getY() * r.getY() < 0 ? Rs.BEHIND : i.magn() < r.magn() ? Rs.BEYOND : t.equals(n) ? Rs.ORIGIN : e.equals(n) ? Rs.DESTINATION : Rs.BETWEEN
                    },
                    sum: function(t) {
                        return new Rs(this.p.x + t.getX(), this.p.y + t.getY())
                    },
                    ...
                    if (4 === arguments.length) {
                        var o = arguments[0],
                            ...
                            x = (p * v - g * y) / m,
                            E = (-d * v + f * y) / m;
                        return a.z + x * (u.z - a.z) + E * (l.z - a.z)
                    }
                }, Rs.LEFT = 0, Rs.RIGHT = 1, Rs.BEYOND = 2, Rs.BEHIND = 3, Rs.BETWEEN = 4, Rs.ORIGIN = 5, Rs.DESTINATION = 6, h(Ts, Rs), e(Ts.prototype, {
                ...
                }), Ms.msgWithSpatial = function(t, e) {
                    return null !== e ? t + " [ " + e + " ]" : t
                }, e(Ds.prototype, {
                    visit: function(t) {},
                    interfaces_: function() {
                    ...
                    locateFromEdge: function(t, e) {
                        for (var n = 0, i = this.quadEdges.size(), r = e;;) {
                            if (++n > i) throw new Ms(r.toLineSegment());
                    ...
                    locate: function() {
                        if (1 === arguments.length) {
                            if (arguments[0] instanceof Rs) {
                                var t = arguments[0];
                                return this.locator.locate(t)
                            }
                            if (arguments[0] instanceof g) {
                                var e = arguments[0];
                                return this.locator.locate(new Rs(e))
                            }
                        } else if (2 === arguments.length) {
                            var n = arguments[0],
                                i = arguments[1],
                                r = this.locator.locate(new Rs(n));
                    ...
                    visit: function(t) {
                        for (var e = t[0].orig().getCoordinate(), n = t[1].orig().getCoordinate(), i = t[2].orig().getCoordinate(), r = Ci.circumcentre(e, n, i), s = new Rs(r), o = 0; o < 3; o++) t[o].rot().setOrig(s)
                    },
                    interfaces_: function() {
                        return [Ds]
                    },
                ...
                }), As.TriangleCircumcentreVisitor = Fs, As.TriangleEdgesListVisitor = Gs, As.TriangleVertexListVisitor = qs, As.TriangleCoordinatesVisitor = Bs, As.EDGE_COINCIDENCE_TOL_FACTOR = 1e3, e(zs.prototype, {
                    ...
                    insert: function() {
                        ...
                        if (2 === arguments.length) {
                            var e = arguments[0],
                                n = arguments[1];
                            if (null === this.root) return this.root = new ks(e, n), this.root;
                            if (this.tolerance > 0) {
                    ...
                    query: function() {
                        ...
                        if (2 === arguments.length)
                            ...
                            else if (arguments[0] instanceof C && R(arguments[1], Vs)) {
                            var r = arguments[0],
                                s = arguments[1];
                ...
                }), Ys.BestMatchVisitor = Us, e(Xs.prototype, {
                        ...
                        for (var e = new I, n = 0, i = new I, r = t.iterator(); r.hasNext();) {
                            ...
                            if (null !== o) {
                                ...
                                var a = this.createVertex(this.splitPt, s),
                                    u = (this.insertSite(a), new zs(s.getStartX(), s.getStartY(), s.getStartZ(), a.getX(), a.getY(), a.getZ(), s.getData())),
                                    l = new zs(a.getX(), a.getY(), a.getZ(), s.getEndX(), s.getEndY(), s.getEndZ(), s.getData());
                    ...
                    formInitialDelaunay: function() {
                        this.computeBoundingBox(), this.subdiv = new As(this.computeAreaEnv, this.tolerance), this.subdiv.setLocator(new _s(this.subdiv)), this.incDel = new bs(this.subdiv), this.insertSites(this.initialVertices)
                    },
                    insertSite: function() {
                    ...
                    create: function() {
                        ...
                        this.subdiv = new As(t, this.tolerance), new bs(this.subdiv).insertSites(e)
                    },
                    ...
                    create: function() {
                        ...
                        var t = Hs.envelope(this.siteCoords),
                            e = new I;
                        null !== this.constraintLines && (t.expandToInclude(this.constraintLines.getEnvelopeInternal()), this.createVertices(this.constraintLines), e = Ws.createConstraintSegments(this.constraintLines));
                ...
                }), Ws.createConstraintSegments = function() {
                    if (1 === arguments.length) {
                        for (var t = arguments[0], e = Vn.getLines(t), n = new I, i = e.iterator(); i.hasNext();) {
                            var r = i.next();
                            Ws.createConstraintSegments(r, n)
                        }
                        return n
                    }
                    if (2 === arguments.length)
                        for (var s = arguments[0], o = arguments[1], a = s.getCoordinates(), i = 1; i < a.length; i++) o.add(new zs(a[i - 1], a[i]))
                }, e(js.prototype, {
                    create: function() {
                        if (null !== this.subdiv) return null;
                        var t = Hs.envelope(this.siteCoords);
                        ...
                        this.subdiv = new As(t, this.tolerance), new bs(this.subdiv).insertSites(n)
                    },
                    getDiagram: function(t) {
                        this.create();
                        var e = this.subdiv.getVoronoiDiagram(t);
                        return js.clipGeometryCollection(e, this.diagramEnv)
                    },
                    setTolerance: function(t) {
                        this.tolerance = t
                    },
                ...
                }), js.clipGeometryCollection = function(t, e) {
                ...
                var Mo = Object.freeze({
                    ...
                    Do = Object.freeze({
                        ConformingDelaunayTriangulationBuilder: Ws,
                        DelaunayTriangulationBuilder: Hs,
                        VoronoiDiagramBuilder: js,
                        quadedge: Mo
                    });
                e(Ks.prototype, {
                    interfaces_: function() {
                ...
                t.version = "1.3.0 (6e65adb)", t.algorithm = lo, t.densify = ho, t.dissolve = co, t.geom = ao, t.geomgraph = fo, t.index = mo, t.io = Eo, t.noding = Io, t.operation = bo, t.precision = Oo, t.simplify = _o, t.triangulate = Do, Object.defineProperty(t, "__esModule", {
                    value: !0
                })
            });
        }, {}],
